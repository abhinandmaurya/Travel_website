...
const Hero = () => {
  ...
  return (
    <section id="hero" className="py-8 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ... text-white relative">
